...
void AnnotatedCameraWidget::drawSLCConfirmation(QPainter &p) {
  ...
  QRect textLeftRect = QRect(leftRect.left(), leftRect.top() + leftRect.height() / 2 - 150, leftRect.width(), leftRect.height() / 2);
  QRect textRightRect = QRect(rightRect.left(), rightRect.top() + rightRect.height() / 2 - 150, rightRect.width(), rightRect.height() / 2);
